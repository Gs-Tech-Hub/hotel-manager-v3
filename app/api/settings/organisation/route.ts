 ...
 * Get organisation settings (public read for currency context, admin for full data)
 */
export async function GET() {
  try {
    ...
    console.error("[API] GET /api/settings/organisation error", e)
...
export async function PUT(req: Request) {
  ...
  try {
    ...
    console.error("[API] PUT /api/settings/organisation error", e)
