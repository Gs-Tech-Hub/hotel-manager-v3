...
async function createUser(req: NextRequest) {
  try {
    ...
    console.log(
      `[ADMIN] Created ${userType} user: ${email} (ID: ${user.id})`
    );
...
async function updateUser(req: NextRequest, id: string) {
  try {
    ...
    console.log(`[ADMIN] Updated ${userType} user: ${id}`);
...
async function deleteUser(req: NextRequest, id: string) {
  try {
    ...
    console.log(`[ADMIN] Deactivated ${userType} user: ${id}`);
