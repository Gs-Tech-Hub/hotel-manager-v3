    ...
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-4 w-96 shadow-lg max-h-[90vh] overflow-auto">
        <div ref={ref} className="font-mono text-sm">
          {/* Hotel Information */}
          <div className="text-center font-bold text-lg mb-1">{hotelInfo?.name || 'Hotel Manager'}</div>
          {hotelInfo?.address && <div className="text-center text-xs text-gray-600">{hotelInfo.address}</div>}
          {hotelInfo?.phone && <div className="text-center text-xs text-gray-600">{hotelInfo.phone}</div>}
          {hotelInfo?.email && <div className="text-center text-xs text-gray-600">{hotelInfo.email}</div>}
          
          <div className="border-t border-b border-gray-300 my-2 py-2 text-center font-bold">
            BOOKING RECEIPT
          </div>
          ...
          <div className="text-center mb-3 pb-2 border-b border-gray-300">
            ...
            <div className="text-sm font-bold font-sans">{reservation.confirmationNo}</div>
          </div>

          {/* Guest Information */}
          <div className="mb-3 pb-2 border-b border-gray-300">
            <div className="text-xs font-bold text-gray-700 mb-1">GUEST INFORMATION</div>
          ...
          {/* Booking Details */}
          <div className="mb-3 pb-2 border-b border-gray-300">
            <div className="text-xs font-bold text-gray-700 mb-1">BOOKING DETAILS</div>
            <div className="text-xs space-y-1">
              <div className="flex justify-between">
